              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    employee.company==null?Text("No Data Available"): Text(' Company Name:${employee.company!.name},\n Bs:${employee.company!.bs},\n Catch Phrase:${employee.company!.catchPhrase}',
                  style: TextStyle(
                    fontSize: 16.0,
                    fontStyle: FontStyle.normal,
                    fontWeight: FontWeight.w300,
                    ...
                    employee.website==null?Text("No Data Available"): Text('${employee.website}',
                      style: TextStyle(
                        fontSize: 16.0,
                        fontStyle: FontStyle.normal,
                        fontWeight: FontWeight.w300,
